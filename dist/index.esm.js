...
var ErrorTrackingPlugin = /*#__PURE__*/function (_EventBus) {
  ...
  return _createClass(ErrorTrackingPlugin, [{
    ...
    value: function windowErrorTracking(sdk, event) {
    ...
    key: "resourceErrorTracking",
    value: function resourceErrorTracking() {
      // 检查已加载的资源是否有错误
    ...
    value: function xHRErrorTracking(sdk) {
      var self = this;
    ...
    value: function fetchErrorTracking(sdk) {
      var self = this;
