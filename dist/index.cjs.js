...
var UserBehaviorPlugin = /*#__PURE__*/function () {
  function UserBehaviorPlugin() {
    ...
    _defineProperty(this, "trackDebounceScrollBehavior", null);
    this.trackDebounceScrollBehavior = lodashExports.debounce(this.scrollBehavior.bind(this), 200);
  }
  return _createClass(UserBehaviorPlugin, [{
    ...
    key: "scrollBehavior",
    value: function scrollBehavior() {
      var e = arguments[0];
      var target = e.target;
      var description = "\u6EDA\u52A8\u4E86 ".concat(target.tagName);
      if (target.id) description += " #".concat(target.id);
      if (target.className) description += " .".concat(target.className);
      if (target.textContent && target.textContent.length < 30) {
        description += " (".concat(target.textContent.trim(), ")");
    ...
    key: "trackHistoryChange",
    value: function trackHistoryChange(trigerType) {
      this.sdk.capture(this.name, {
        type: "history",
